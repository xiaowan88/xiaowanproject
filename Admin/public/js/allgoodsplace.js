...
form[0].addEventListener('submit', function (e) {
    ...
    lo.push({
        ...
        place,
        placeid: lo.length ? lo[lo.length - 1].placeid  + 1 : 1,
    })
...
function update(userid) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            document.querySelectorAll('#place')[1].value = res.place;
...
btn.onclick = function () {
    ...
    let place = document.querySelectorAll('#place')[1].value;
...
function xgan() {
    ...
    btn2.addEventListener('click', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                document.querySelectorAll('#place')[2].value = res.place;
    ...
    btn9.addEventListener('click', function () {
        ...
        let chall = document.querySelector('.chall');
        let place = document.querySelectorAll('#place')[2].value;
